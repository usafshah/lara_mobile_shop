    ...
    <div class="row">
     ...
     <div class="col-md-4">
            <div class="panel panel-default">
                <div class="panel-heading">Purchase a product</div>
                <div class="panel-body">
                    <input type="text" name="q" id="q" placeholder="Search" class="form-control ">
                    <input type="hidden" name="id" id="pid" >
                    <button type="button" id="add_btn" class="btn btn-primary btn-block" style="margin-top: 10px;">Show Record</button>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
 $('#add_btn').click(function(){
          ...
          if (id!='') {
            ...
            alert('enter product to Purchase');
        }
        });
